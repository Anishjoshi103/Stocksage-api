...
module.exports = async function handler(req, res) {
  ...
  try {
    const [chartRes, summaryRes] = await Promise.all([
      fetch(`https://query1.finance.yahoo.com/v8/finance/chart/${yfSymbol}?interval=1d&range=1mo`, { headers }),
      fetch(`https://query1.finance.yahoo.com/v10/finance/quoteSummary/${yfSymbol}?modules=defaultKeyStatistics,financialData,summaryProfile,summaryDetail`, { headers })
    ]);
